...
const AddPage = () => {
    ...
    return (
        <div className='w-full h-fit lg:h-[484px] flex justify-center items-center bg-[#F7FDFF] px-[24px] lg:p-0 my-[48px]'>
            ...
            <div className='w-[90%] min-h-[236px] lg:w-[1240px] lg:h-[284px] flex flex-col gap-[12px] lg:gap-[32px] border-2 border-gray-200 p-[24px] lg:p-[40px] bg-white rounded-[8px]'>
                ...
                {/* BUTTON */}
                <p onClick={() => navigate("/addList")} className='w-[100%] lg:w-[121px] h-[32px] lg:h-[40px] flex justify-center items-center rounded-[8px] border-2 border-[#8064A2] text-[#8064A2] text-[12px] lg:text-[18px] font-semibold p-2'>Add new</p>
